...
class TestInsertYear(unittest.TestCase):
    def testSingles(self):
        ...
        self.assertEqual([(2010, 2010), (2012, 2012), (2015, 2015)], years)

        years = [(2014, 2014)]
        result = insert_year(2016, years)
        self.assertTrue(result)
        self.assertEqual([(2014, 2014), (2016, 2016)], years)

        years = [(2014, 2014)]
        result = insert_year(2012, years)
        self.assertTrue(result)
        self.assertEqual([(2012, 2012), (2014, 2014)], years)
    ...
    def testWithinExisting(self):
        ...
        self.assertEqual(expected, years)
    ...
    def testUpdateExisting(self):
        ...
        self.assertTrue(result)
        self.assertEqual([(2006, 2007), (2009, 2011), (2014, 2015)], years)

        years = base_years[:]
        result = insert_year(2008, years)
        self.assertTrue(result)
        self.assertEqual([(2006, 2006), (2008, 2011), (2014, 2015)], years)

        years = base_years[:]
        result = insert_year(2012, years)
        self.assertTrue(result)
        self.assertEqual([(2006, 2006), (2009, 2012), (2014, 2015)], years)

        years = base_years[:]
        result = insert_year(2013, years)
        self.assertTrue(result)
        self.assertEqual([(2006, 2006), (2009, 2011), (2013, 2015)], years)

        years = base_years[:]
        result = insert_year(2016, years)
        self.assertTrue(result)
        self.assertEqual([(2006, 2006), (2009, 2011), (2014, 2016)], years)
...
class TestCopyrightedFile(unittest.TestCase):
    ...
    def testCommaLists(self):
        m, copyrights = self.cf._match_line(
            "# Copyright © 2010,2012,2014 Foo Corp, Inc."
        )
        self.assertIsNotNone(m)
        self.assertEqual(
            [
    ...
    def testComplexDates(self):
        m, copyrights = self.cf._match_line(
            " # Copyright: 2013,2015-2017 Foo Corp, Inc."
        )
        self.assertIsNotNone(m)
        self.assertEqual(
            [
        ...
        m, copyrights = self.cf._match_line(
            " # Copyright: 2010-2014, 2016 Foo Corp, Inc."
        )
        self.assertIsNotNone(m)
        self.assertEqual(
            [
        ...
        m, copyrights = self.cf._match_line(
            " # Copyright: 2005 - 2010, 2013, 2015 - 2017 Foo Corp, Inc."
        )
        self.assertIsNotNone(m)
        self.assertEqual(
            [
    ...
    def testPrcoessLineThisYear(self):
        result = self.cf._process_line(
            f"# Copyright {self.this_year} {self.copyright_name}"
        )
...
""".format(self.last_year, self.this_year, self.copyright_name)
        ...
        self.assertEqual(expected, self.cf._lines)
...
""".format(self.this_year, self.copyright_name)
        ...
        self.assertEqual([], self.cf._lines)
...
"""
    ...
    def testUncommented(self):
        ...
        m, copyrights = cf2._match_line(f" Copyright 2015 {self.copyright_name}")
        self.assertIsNotNone(m)
        self.assertEqual([(2015, 2015)], copyrights)
